...
$photo = eZFlickrPhoto::fetch($Params["PhotoID"]);
$tpl = templateInit();
$tpl->setVariable("photo",$photo);
$tpl->setVariable("view_parameters",$Params["UserParameters"]);

$Result['path']=array(
                        array(  'text' =>  ezi18n( 'flickr/main', 'Flickr Library' ),
                                'url' => "flickr/home" ),
                        array(  'text' =>  ezi18n( 'flickr/main', 'Photo' ),
                                'url' => false ),
                        array(  'text' =>  $photo->attribute("title"),
                                'url' => false ),
                        );


$Result['content']=$tpl->fetch("design:flickr/photo.tpl");
