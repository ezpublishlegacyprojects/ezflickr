...
menuArray['MUpload']['elements'] = new Array();
 ...
 <hr/>
    <a id="menu-mupload" href="#" onclick="ezpopmenu_submitForm( 'menu-form-mupload' ); return false;" >{"Import form Flickr"|i18n("flickr/main")}</a>

<form id="menu-form-mupload" method="post" action={"/content/action"|ezurl()}>
